                        ...
                        <table class="table table-responsive-sm table-hover table-outline mb-0">
                            ...
                            @foreach($participants->certificates as $certificado )
                                <tr>
                                    ...
                                    <td>{{ optional($certificado->course->calendar->start_date)->format('D')}}  {{optional($certificado->course->calendar->start_date)->format('d')}} de {{optional($certificado->course->calendar->start_date)->format('M')}}  del {{optional($certificado->course->calendar)->start_date->format('Y')}}</td>
