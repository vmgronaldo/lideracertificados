        ...
        <div class="row main-form">
            <div class="col-md-6 first-column">
                ...
                <input type="hidden" name="asunto" id="asunto" v-model="fields.asunto"
                       value="Promoción y colocación de tu inmueble">

                <p class="title"><span>1.</span> Completa las características
                    principales de tu inmueble.</p>

                <div class="operacion">
                    <input type="radio" id="alquiler" name="operacion" v-model="fields.operacion" class="checkbox" checked value="1"/>
                    <label for="alquiler" class="checkbox-label">
                        <span>En Alquiler</span>
                    </label>
                    <input type="radio" id="venta" name="operacion" v-model="fields.operacion" class="checkbox"
                           value="2"/>
                    <label for="venta" class="checkbox-label">
                        <span>En Venta</span>
                    </label>
                </div>
                ...
                <div class="tipo">
                    ...
                    <input type="radio" id="departamento" name="tipo" v-model="fields.tipo" checked class="checkbox"
                           value="1"/>
                    <label for="departamento" class="checkbox-label">
                        <span>Departamento</span>
                    </label>

                    <input type="radio" id="casa" name="tipo" v-model="fields.tipo" class="checkbox" value="2"/>
                    <label for="casa" class="checkbox-label">
                        <span>Casa</span>
                    </label>

                    <input type="radio" id="oficina-administrativa" v-model="fields.tipo" name="tipo" class="checkbox"
                           value="5"/>
                    <label for="oficina-administrativa" class="checkbox-label">
                        <span>Oficina</span>
                    </label>
                    <input type="radio" id="local-comercial" name="tipo" v-model="fields.tipo" class="checkbox"
                           value="3"/>
                    <label for="local-comercial" class="checkbox-label">
                        <span>Local Comercial</span>
                    </label>

                    <input type="radio" id="terreno" name="tipo" v-model="fields.tipo" class="checkbox"
                           value="9"/>
                    <label for="terreno" class="checkbox-label">
                        <span>Terreno</span>
                    </label>
                ...
                <div class="presupuesto">
                    <p>El presupuesto mínimo para acceder al servicio gratuito de búsqueda de inmuebles, deberá ser de  US$700* en adealnte.
                        <a href="">¿Por qué?</a></p>
                </div>
        ...
        data() {
            return {
                ...
                fields: {
                    ...
                    asunto: 'Promoción y colocación de tu inmueble',
                    price: this.price,
                    email: this.email,
