<template>
    <form v-loading="loaded" class="formulario-contacto form-login" @submit.prevent="submit" autocomplete="off">
        ...
        <div class="form-group">
            <div class="password-main">
                <input v-model="fields.password" type="password" class="form-control" id="password" name="password"
                       required
        ...
        <a href="#" id="PasswordVerify">Olvide mi contraseña</a>
    </form>
</template>
    ...
    export default {
        ...
        methods: {
            submit() {
                ...
                this.errors = {};
                var vm = this;
                axios.post(casella.login, this.fields).then(response => {
