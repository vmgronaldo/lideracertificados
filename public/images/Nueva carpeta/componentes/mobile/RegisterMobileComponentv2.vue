<template>
    <form
        ...
        <div class="form-group"><div class="custom-control custom-checkbox  terms-login"><input id="accept_terms" required type="checkbox" name="accept_terms" class="custom-control-input"> <label for="accept_terms" class="custom-control-label"><span>Acepta</span> <a href="#">Terminos y
