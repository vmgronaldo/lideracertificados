<template>
    <div class="buttons-add">
        ...
        <input  type="number"  name="dormitorios" id="dormitorios" :min="1" :max="8" :value="counter">
        <button class="maxbutton" type="button" v-on:click="increment"><img :src="agregar" alt=""></button>
    </div>
</template>
