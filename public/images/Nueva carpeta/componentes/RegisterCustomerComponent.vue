<template>
    <form
        v-loading="loaded"
        class="formulario-login form-login" @submit.prevent="submit" autocomplete="off">
        ...
        <input type="checkbox" name="accept_terms" class="custom-control-input" checked>
        <a href="#" id="accept_terms">Terminos y
            condiciones</a>
